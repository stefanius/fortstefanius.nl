    ...
    <div id="main_content">
        ...
        <div class="box">
            ...
            <ul class="master_tabs" id="loadlive" style="margin-bottom:2px">
                <li class="current"><a href="/user/external"><span>Overzicht</span></a></li>
                <li><a href="/user/external/add"><span>Toevoegen</span></a></li>
            </ul>
                ...
                <table width="100%" id="table_sort" class="table_data">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="align_l">Email</th>
                            <th class="align_l">Telefoon</th>
                            <th class="align_l">Mobiel</th>
                            <th>Wijzig</th>
                            <th>Verwijder</th>
                        </tr>
                    </thead>
...
<?php foreach ($Users as $User): ?>
                        <tr>
                            ...
                            <td class="align_c" style="line-height: 0;"><a href="/user/external/<?php echo $User->getId(); ?>/edit"><img src="/assets/img/icons/pencil.png" alt="" class="icon" /></a></td>
                            <td class="align_c" style="line-height: 0;"><a href="/user/external/<?php echo $User->getId(); ?>/delete"><img src="/assets/img/icons/cross.png" alt="" class="icon" /></a></td>
                        </tr>
<?php endforeach; ?>
                    </tbody>
                </table>
...
<script type="text/javascript">
    ...
    window.addEvent('domready', function() {
        ...
        new Autocompleter.Request.JSON($('user_search_string'), '/json/search/externaluser', {
            'selectMode': false,
            'filterSubset': true,
            'minLength': 2,
            'indicatorClass': 'autocompleter-loading',
            'onSelection': function(input, li) {
                new URI('/user/external/' + li.getFirst('span').get('rel')).go();
            }
        });
