    ...
    <div id="main_content">
        ...
        <div class="box">
            ...
            <ul class="master_tabs" id="loadlive" style="margin-bottom:2px">
                <li class="current"><a href="/user"><span>Overzicht</span></a></li>
                ...
                <table width="100%" id="table_sort" class="table_data">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="align_l">E-mailadres</th>
                            <th>Wijzig</th>
                            <th>Verwijder</th>
                        </tr>
                    </thead>
...
?>
                        <tr>
                            ...
                            <td class="align_c" style="line-height: 0;"><a href="/user/<?php echo $User->getId(); ?>/edit"><img src="/assets/img/icons/pencil.png" alt="" class="icon" /></a></td>
                            <td class="align_c" style="line-height: 0;"><a href="/user/<?php echo $User->getId(); ?>/delete"><img src="/assets/img/icons/cross.png" alt="" class="icon" /></a></td>
                        </tr>
<?php
...
<script type="text/javascript">
    ...
    window.addEvent('domready', function() {
            ...
            'update': function(tokens) {
                ...
                if (!type || (type == 'array' && !tokens.length) || (type == 'hash' && !tokens.getLength())) {
                    ...
                    tokens.each(this.options.injectChoice || function(token){
                        var match = token.firstname + ' ' + token.surname + ' (' + token.email + ')';
        ...
        new Autocompleter.Request.JSON($('user_search_string'), '/json/search/user', {
            'selectMode': false,
            'filterSubset': true,
            'minLength': 2,
            'indicatorClass': 'autocompleter-loading',
            'onSelection': function(input, li) {
                new URI('/user/' + li.getFirst('span').get('rel')).go();
            }
        });
